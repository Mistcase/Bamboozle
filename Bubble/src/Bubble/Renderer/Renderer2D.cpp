...
namespace bubble
{
    ...
    namespace Renderer2D
    {
        void Init()
        {
            ...
            BUBBLE_CORE_ASSERT(SceneData()->textureSlots.size() > 2, "Cannot render user provided textures");
        ...
        {
            BUBBLE_CORE_ASSERT(texture != nullptr, "Texture is nullptr");
